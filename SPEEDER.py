...
setTitle(f"Proxies    |    ")
choice = input(f"\n[\x1b[95m>\x1b[95m\x1B[37m] Would You Like To Use Proxies? [Y/N]: {c}")
if choice.lower() == 'y' or choice.lower() == 'yes':
        ...
        try:
            ...
            print(f"{Fore.RED}Your Python Version is Not supported: ({sys.version_info[0]}.{sys.version_info[1]}.{sys.version_info[2]}), Please Download v3.9+ to use SPEEDER-Nuker!{Fore.RESET}")
            sleep(5)
...
try:
    ...
    with open('data/logins.json', 'w') as f:
            print(f"\n[{g}#\x1b[95m\x1B[37m] Logging Into SPEEDER-Nuker")
...
def spammer():
    ...
    print('')
    print('')
    Write.Print(f'[discord.gg/hGBvUMqG63]\n', Colors.blue_to_cyan,  interval=0.000)
    Write.Print(f'[WEBSITE SOON]\n', Colors.blue_to_cyan,  interval=0.000)
    Write.Print(f'[github.com/JavorR1]\n', Colors.blue_to_cyan,  interval=0.000)
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.blue_to_cyan, interval=0.000)
    print(f'''{m}'''.replace('$', f'{m}${w}') + f'''
{c}[{w}1{Fore.RESET}{c}]{Fore.RESET} Server Joiner   {b}|{Fore.RESET}{c}[{w}9{Fore.RESET}{c}]{Fore.RESET}  Channel Spammer   {b}|{Fore.RESET}{c}[{w}17{Fore.RESET}{c}]{Fore.RESET} Patch Notes{Fore.RESET}         {b}|{Fore.RESET}{c}[{w}25{Fore.RESET}{c}]{Fore.RESET} Token Generator{Fore.RESET}
{c}[{w}2{Fore.RESET}{c}]{Fore.RESET} Server Leaver   {b}|{Fore.RESET}{c}[{w}10{Fore.RESET}{c}]{Fore.RESET} DM Spammer        {b}|{Fore.RESET}{c}[{w}18{Fore.RESET}{c}]{Fore.RESET} About/Activity{Fore.RESET}      {b}|{Fore.RESET}{c}[{w}26{Fore.RESET}{c}]{Fore.RESET} Nitro Generator{Fore.RESET}
{c}[{w}3{Fore.RESET}{c}]{Fore.RESET} Token Checker   {b}|{Fore.RESET}{c}[{w}11{Fore.RESET}{c}]{Fore.RESET} Friend Spammer    {b}|{Fore.RESET}{c}[{w}19{Fore.RESET}{c}]{Fore.RESET} Server Lookup{Fore.RESET}       {b}|{Fore.RESET}{c}[{w}27{Fore.RESET}{c}]{Fore.RESET} QR Token Grabber{Fore.RESET}
{c}[{w}4{Fore.RESET}{c}]{Fore.RESET} Token Onliner   {b}|{Fore.RESET}{c}[{w}12{Fore.RESET}{c}]{Fore.RESET} HypeSquad Joiner  {b}|{Fore.RESET}{c}[{w}20{Fore.RESET}{c}]{Fore.RESET} Token Infomation{Fore.RESET}    {b}|{Fore.RESET}{c}[{w}28{Fore.RESET}{c}]{Fore.RESET} Member ID Scraper{Fore.RESET}
{c}[{w}5{Fore.RESET}{c}]{Fore.RESET} Token Grabber   {b}|{Fore.RESET}{c}[{w}13{Fore.RESET}{c}]{Fore.RESET} Reaction Spammer  {b}|{Fore.RESET}{c}[{w}21{Fore.RESET}{c}]{Fore.RESET} Status Changer{Fore.RESET}      {b}|{Fore.RESET}{c}[{w}29{Fore.RESET}{c}]{Fore.RESET} PFP Changer{Fore.RESET}
{c}[{w}6{Fore.RESET}{c}]{Fore.RESET} Server MassDM   {b}|{Fore.RESET}{c}[{w}14{Fore.RESET}{c}]{Fore.RESET} NickName Changer  {b}|{Fore.RESET}{c}[{w}22{Fore.RESET}{c}]{Fore.RESET} Group Spammer{Fore.RESET}       {b}|{Fore.RESET}{c}[{w}30{Fore.RESET}{c}]{Fore.RESET} About{Fore.RESET}
{c}[{w}7{Fore.RESET}{c}]{Fore.RESET} Account Nuker   {b}|{Fore.RESET}{c}[{w}15{Fore.RESET}{c}]{Fore.RESET} Webhook Spammer   {b}|{Fore.RESET}{c}[{w}23{Fore.RESET}{c}]{Fore.RESET} Auto Login{Fore.RESET}          {b}|{Fore.RESET}{c}[{w}31{Fore.RESET}{c}]{Fore.RESET}{lr} THREADS{Fore.RESET}
{c}[{w}8{Fore.RESET}{c}]{Fore.RESET} Server Nuker    {b}|{Fore.RESET}{c}[{w}16{Fore.RESET}{c}]{Fore.RESET} VC Spammer        {b}|{Fore.RESET}{c}[{w}24{Fore.RESET}{c}]{Fore.RESET} DM Deleter{Fore.RESET}          {b}|{Fore.RESET}{c}[{w}32{Fore.RESET}{c}]{Fore.RESET}{lr} EXIT{Fore.RESET}''')
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.blue_to_cyan, interval=0.000)
    choice = input(f'{c}[{w}>{c}]{w} Choice?: ')
...
#   JOINER
    if choice == '1':
        ...
        gh = input(f"""
Server Joiner is currently OUTDATED, wait for the next UPDATE, you will be notified on our discord server!\n!
                                   
[\x1b[95m1\x1b[95m\x1B[37m] SPEEDER-Nuker Website & Discord
[\x1b[95m2\x1b[95m\x1B[37m] Exit
  
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)

        if gh in ['01','1']:
            webbrowser.open('https://speedernuker.netlify.app/')
            webbrowser.open('https://discord.gg/hGBvUMqG63')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
#   TOKEN ONLINER
    if choice == '4':
            ...
            config = {
                ...
                "state": "https://speedernuker.netlify.app",
                "name": "SPEEDER NUKER",
            }
        ...
        def main():
            ...
            async def on_ready():
                if len(gang.guilds) > 1:
                    ...
                    guildpl = "guild"
                activity = discord.Game(name=f"SPEEDER-Nuker Server Nuker", type=3)
            ...
            async def nuke(ctx):
                ...
                await ctx.guild.edit(name="SPEEDER-Nuker Runs Discord")
...
#   DM SPAMMER
    if choice == '10':
        ...
        gh = input(f"""
DM Spammer is in the OUTDATED Version of SPEEDER-Nuker!\nSoon Updated
...
#   TOKEN GENERATOR
    if choice == '25':
        ...
        gh = input(f"""
Token Generator is in the Paid Version of DISCORD SERVER!\nIf You Are Wanting to Purchase Make Sure to Checkout the Offical SPEEDER-Nuker Discord!
